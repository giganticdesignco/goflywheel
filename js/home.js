...
// 			console.log($('.not-ready-yet').offset().top)
// 			console.log($(window).scrollTop())

// 			if($(window).scrollTop() + window.innerHeight >= $('.not-ready-yet').offset().top - $('.not-ready-yet').height() ) {
// 				$d1.css({
// 					'transform': 'translateX(' + - number * 8 + 'px) scale(1.2)'
// 				});
// 			}
// 		}
// 	}
